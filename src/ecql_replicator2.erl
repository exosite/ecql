...
%%
%% ecql_replicator2.erl - Replicator that forwards reads and writes
%%==============================================================================
-module(ecql_replicator2).
...
start_shadow() ->
  ...
  ,SpawnOpt = [{max_heap_size, MaxHeapSize}, {message_queue_data, on_heap}]
  ,Opts = [{spawn_opt, SpawnOpt}]
  ,{ok, Pid} = gen_server:start_link(ecql_replicator_shadow, [], Opts)
  ,Pid
.
